...
export default function NeuPage() {
  ...
  // Projekte laden wenn Bautagebuch ausgewählt
  useEffect(() => {
          ...
          <div className="flex flex-col gap-6">
            ...
            {selectedTyp === 'bautagebuch' && (
              <>
                ...
                <div>
                  <p className="text-xs text-[#444] uppercase tracking-widest mb-2">Projekt</p>
                  <select
                    value={projektId}
                    onChange={e => setProjektId(e.target.value)}
                    className="w-full bg-[#181818] border border-[#2a2a2a] rounded-xl px-4 py-3 text-sm text-[#f0ede8] focus:outline-none focus:border-[#d4e840] transition-colors"
                  >
            ...
            {selectedTyp === 'bautagebuch' && (
              <div>
                <p className="text-xs text-[#444] uppercase tracking-widest mb-2">Fotos</p>
                <input
                  ref={fotoInput}
                  type="file"
                  accept="image/*"
                ...
                <button
                  ...
                  className="w-full py-3 border border-dashed border-[#2a2a2a] rounded-xl text-xs text-[#555] hover:border-[#d4e840] hover:text-[#d4e840] transition-all flex items-center justify-center gap-2"
                >

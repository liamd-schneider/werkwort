    ...
    <>
      ...
      <nav className="hidden md:flex fixed left-0 top-0 bottom-0 w-[200px] z-50 bg-[#0d0d0d] border-r border-[#1a1a1a] flex-col">
        ...
        <div className="px-3 py-4 border-t border-[#1a1a1a]">
          <div className="flex items-center justify-between px-3"><p className="text-xs text-[#2a2a2a]">Werkwort Beta</p><NotificationBell/></div>
        </div>
      </nav>
      ...
      <div className="md:hidden">
        ...
        {/* Sheet */}
        <div className={`fixed bottom-0 left-0 right-0 z-50 bg-[#0d0d0d]/95 backdrop-blur-2xl border-t border-[#1e1e1e] rounded-t-3xl transition-transform duration-[380ms] ease-[cubic-bezier(0.32,0.72,0,1)] ${open ? 'translate-y-0' : 'translate-y-full'}`}
